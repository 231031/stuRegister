...
export default function Admintableteach() {
    ...
    function handleUpdate(id) {
        // link to update page of teacher update
    }

    function handleDel(id) {
        // before delete must relpace someone -> select someone to replace and then delete
    }
                          ...
                          teacher.map((teaList, index) => (
                              <tr key={index}>
                                ...
                                <Row className='cursor-pointer hover:bg-red-300'>
                                    <button className='text-red-600 ' onClick={(e) => handleDel(teaList.teacher_id)}>Del</button>
                                </Row>
                              </tr>
                          ))
                      }
