...
export default function Landing() {
  ...
  return (
    <HelmetProvider>
      <div className='flex flex-col justify-center bg-white items-center h-screen w-full ' >
        <Helmet>
          <title >Registration</title>
        </Helmet>
        <h2 className='text-5xl font- text-darkgreen mb-10'>Registration System | KMUTT</h2>
        <div className='flex flex-col items-center bg-sky rounded-xl p-8 justify-center'>
        ...
        <div className='flex flex-row justify-center '>
          ...
          <Btn>
            ...
            <p className='mt-4 text-white text-2xl '>Student</p>
          </Btn>
