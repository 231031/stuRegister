                    ...
                    <!-- About Section --> */}
                                ...
                                <div class="bg-sky p-3 shadow-sm rounded-sm">
                                    ...
                                    <div class="grid md:grid-2 text-sm">
                                        <div class="flex ">
                                            <div className='mt-5 w-300  px-3 mb-6 md:mb-0' >
                                                <label className="block uppercase tracking-wide text-white text-xs font-bold mb-2" htmlFor="grid-f-salary">
                                                    Salary :
                                                </label>
                                                ...
                                                <input
                                                    ...
                                                    className="block appearance-none w-700 bg-white text-gray-700 border border-gray-200 rounded py-3  px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-f-salary" type="text" style={{ height: 50, width: 300 }} />
